        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cedula = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    MotivoDeshabilitacion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FechaDeshabilitacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreadoPor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModificadoPor = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CelulaLideres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CelulaLideres_Celulas_CelulaId",
                        column: x => x.CelulaId,
                        principalTable: "Celulas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CelulaLideres_Consultores_ConsultorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CelulaMiembros", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CelulaMiembros_Celulas_CelulaId",
                        column: x => x.CelulaId,
                        principalTable: "Celulas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CelulaMiembros_Consultores_ConsultorId",
                        column: x => x.ConsultorId,
                        principalTable: "Consultores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditoriaLogs_FechaCreacion",
                table: "AuditoriaLogs",
                column: "FechaCreacion");

            migrationBuilder.CreateIndex(
                name: "IX_AuditoriaLogs_Modulo",
                table: "AuditoriaLogs",
                column: "Modulo");

            migrationBuilder.CreateIndex(
                name: "IX_CelulaLideres_CelulaId_ConsultorId",
                table: "CelulaLideres",
                columns: new[] { "CelulaId", "ConsultorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CelulaLideres_ConsultorId",
                table: "CelulaLideres",
                column: "ConsultorId");

            migrationBuilder.CreateIndex(
                name: "IX_CelulaMiembros_CelulaId_ConsultorId",
                table: "CelulaMiembros",
                columns: new[] { "CelulaId", "ConsultorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CelulaMiembros_ConsultorId",
                table: "CelulaMiembros",
                column: "ConsultorId");

            migrationBuilder.CreateIndex(
                name: "IX_Consultores_Email",
                table: "Consultores",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Notificaciones_Enviado",
